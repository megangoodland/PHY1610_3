...
antsontable3: antsontable_3.o random_partition.o report_4_integers.o array_2d_tools.o ants_move_once.o netCDF_writing.o
	${CXX} -std=c++11 -O3 -march=native antsontable_3.o random_partition.o report_4_integers.o array_2d_tools.o ants_move_once.o netCDF_writing.o -o antsontable3
...
netCDF_writing.o: netCDF_writing.cpp netCDF_writing.h
	${CXX} -std=c++11 -O3 -march=native -c netCDF_writing.cpp
